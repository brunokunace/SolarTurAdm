...
<script type="text/javascript">
  ...
  import MixinComputed from 'src/app/common/form/mixins/computed'
  import MixinHooks from 'src/app/common/form/mixins/hooks'
  import MixinMethods from 'src/app/common/form/mixins/methods'
  import MixinProps from 'src/app/common/form/mixins/props'
  import MixinData from 'src/app/common/form/mixins/data'

  import FormActions from 'src/app/common/form/components/FormActions.vue'
